...
app.get('/port.txt', function (req, res) {
  try {
    var _port = fs.readFileSync(portFilePath, 'utf8');
...
app.post('/api/run-visual-test', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, command, component, story, projectRoot, testCommand;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, command = _req$body.command, component = _req$body.component, story = _req$body.story;
        ...
        case 4:
          ...
          return _context.abrupt("return", res.status(400).json({
            error: 'Missing component or story name'
          }));
        case 6:
          ...
          testCommand = "npm run test:visual:story ".concat(component);
